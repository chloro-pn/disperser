...
public:
  StlEntity():loaded_(false),get_result_(false) {}
  ...
  void disperse(double grid_size) {
    ...
    size_t x_count = (box.max_x - box.least_x) / grid_size + 1;
    size_t y_count = (box.max_y - box.least_y) / grid_size + 1;
    size_t z_count = (box.max_z - box.least_z) / grid_size + 1;
